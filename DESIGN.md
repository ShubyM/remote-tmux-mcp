...
The main design point is that command execution is visible in tmux while command control is structured through MCP tools and newline-delimited JSON. Each command run gets its own tmux window/tab, not a split pane.
